...
const DIGIT_H = 3; // rem per digit cell (h-12)
...
function OdometerDigit({
  ...
  return (
    <div className="relative h-12 w-8 overflow-hidden rounded-sm bg-neutral-900 shadow-[inset_0_2px_4px_rgba(0,0,0,0.6),inset_0_-1px_2px_rgba(255,255,255,0.05)]">
      <div
      ...
      >
        ...
        {Array.from({ length: 11 }, (_, n) => (
          <div
            key={n}
            className="flex h-12 items-center justify-center font-mono text-xl font-bold text-white"
          >
            {n % 10}
          </div>
        ))}
